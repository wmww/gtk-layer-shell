...
// Version ID 2
// Valid for GTK v3.22.16 - v3.24.24 (unreleased)
...
struct gtk_primary_selection_device * gdk_wayland_seat_priv_get_primary_data_device(GdkWaylandSeat * self) {
  switch (gdk_wayland_seat_priv_get_version_id()) {
...
void gdk_wayland_seat_priv_set_primary_data_device(GdkWaylandSeat * self, struct gtk_primary_selection_device * primary_data_device) {
  switch (gdk_wayland_seat_priv_get_version_id()) {
